...
const difficultyColors = {
    easy: "bg-green-100 text-green-700 border border-green-300 hover:bg-green-300",
    medium: "bg-yellow-100 text-yellow-700 border border-yellow-300  hover:bg-yellow-300",
    hard: "bg-red-100 text-red-700 border border-red-300  hover:bg-red-300",
};
        ...
        <div className="w-full bg-white p-6 rounded-lg shadow-lg border border-gray-200">
            ...
            <div className="flex items-center py-4">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="ml-auto border-gray-300 hover:bg-gray-100">
                            Columns <ChevronDown className="ml-2 h-4 w-4" />
                        </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent align="end" className="bg-white border border-gray-300 shadow-md">
                        {table
                            .getAllColumns()
                    ...
                    <TableBody>
                        {table.getRowModel().rows.length ? (
                            table.getRowModel().rows.map((row) => (
                                <TableRow key={row.id} className="border-b border-gray-300 hover:bg-gray-100">
            ...
            <div className="flex items-center justify-end space-x-2 py-4">
                ...
                <div className="space-x-2">
                    <Button variant="outline" size="sm" className="border-gray-300 hover:bg-gray-100" onClick={() => table.previousPage()} disabled={!table.getCanPreviousPage()}>
                        Previous
                    </Button>
                    <Button variant="outline" size="sm" className="border-gray-300 hover:bg-gray-100" onClick={() => table.nextPage()} disabled={!table.getCanNextPage()}>
                        Next
                    </Button>
                </div>
            </div>
